...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[1] = LAYOUT(
		...
		KC_LCTL, KC_LALT, KC_LGUI, KC_TRNS, LGUI(KC_ENT), MT_ALT_BSPC, LALT(KC_DEL), KC_MPLY, KC_NO, KC_MRWD, KC_MFFD
	),
	[2] = LAYOUT(
	...
	[3] = LAYOUT(
		...
		KC_NO, LAG_SWP, LAG_NRM, KC_MPLY, KC_MUTE, KC_MPLY, KC_TRNS, KC_MPLY, KC_NO, KC_MRWD, KC_MFFD
	)
};
