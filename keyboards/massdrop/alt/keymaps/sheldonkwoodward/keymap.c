...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
    switch (keycode) {
        // custom functionality for toggling RGB on and off for the keyboard
        case RGB_TOG:
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[1] = LAYOUT_65_ansi_blocker(
        ...
        KC_TRNS, KC_NO, KC_NO, KC_PGUP, KC_NO, KC_NO, KC_NO, KC_NO, KC_UP, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_MPLY,
        KC_TRNS, KC_HOME, LALT(KC_LEFT), KC_PGDN, LALT(KC_RGHT), KC_END, KC_NO, KC_LEFT, KC_DOWN, KC_RGHT, KC_NO, KC_NO, LGUI(KC_ENT), KC_MFFD,
        KC_TRNS, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_TRNS, KC_RSFT, KC_MRWD,
